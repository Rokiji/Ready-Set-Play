    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container mx-auto px-6 py-12 flex-grow">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl font-bold mb-6 text-center">About Ready, Set, Play</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-game-primary/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Gamepad className="text-game-primary h-8 w-8" />
              </div>
              <h3 className="font-bold text-lg mb-2">Diverse Game Library</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-game-secondary/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Music className="text-game-secondary h-8 w-8" />
              </div>
              <h3 className="font-bold text-lg mb-2">Integrated Music Player</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-game-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="text-game-accent h-8 w-8" />
              </div>
              <h3 className="font-bold text-lg mb-2">Community Features</h3>
              <p className="text-gray-600">
          ...
          <div className="bg-gray-50 rounded-xl p-8 text-center">
            ...
            <p className="mb-6">Ready, Set, Play was created by The Three Stooges, a passionate team of developers and gaming enthusiasts.</p>
            <p className="text-game-primary font-medium">© 2023 The Three Stooges. All rights reserved.</p>
          </div>
        </div>
      </main>
